...
public class CatalogoLivros {
    ...
    public String pesquisarPorTitulo(String titulo) {
        ...
        if (!livroList.isEmpty()) {
            ...
            throw new RuntimeException("A lista está vazia!"); // Lançar exceção se a lista estiver vazia
        }

        if (livroPorTitulo != null) {
            return livroPorTitulo.toString(); 
        } else {
            return "Livro não encontrado com o título: " + titulo;
        }
    }
